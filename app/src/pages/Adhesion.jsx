...
const Adhesion = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const user = await register(JSON.stringify(data)).then(rep => console.log('artiste enregistré', rep))
            const response = await addArtist(JSON.stringify({ data: [name, email, adresse, genre, date_naissance] })).then(rep => console.log('artiste enregistré', rep));
            ...
            <div className="h-full">
                <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                    ...
                    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                        ...
                        <form className='bg-slate-400 p-2 rounded-lg' onSubmit={handleSubmit}>
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                ...
                                <label
                                    ...
                                    className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-slate-600 transition-all duration-200 ease-out peer-focus:-translate-y-[2.15rem] peer-focus:scale-[0.8] ${name && 'scale-[0.8] text-primary -translate-y-[2.15rem]'
