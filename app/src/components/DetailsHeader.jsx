    ...
    <div className="relative w-full flex  flex-col">
      ...
      <div className="w-full bg-gradient-to-l from-transparent to-black sm:h-48 h-28">
        <div className="absolute inset-0 flex items-center">
          <img src={`http://localhost:1337${artistData?.data.attributes.image.data[0].attributes.url}`} alt="" className="sm:w-48 w-28 sm:h-48 h-28 rounded-full object-cover shadow-xl shadow-black " />
          <div className="ml-5">
