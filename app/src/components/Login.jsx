      ...
      <div className="h-full">
        <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <p class="text-slate-200 text-center mb-0 mr-4 text-3xl">
              Se connecter
            </p>
            ...
            <form className=" bg-slate-400 p-2 rounded-lg ">
              ...
              <div class="text-center flex flex-row  justify-center lg:text-left">
                <button
                  type="button"
                ...
                <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ...
                  <a
                    onClick={() => switchPage()}
                    class="ml-3 text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
                  >
                    S'inscrire
                  </a>
                </p>
