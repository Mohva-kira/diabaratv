    ...
    <section className="h-screen">
      <div className="h-full">
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 text-center">
            <p className="text-slate-200 mb-0 mr-4 text-3xl">Inscription</p>
            <form className=" bg-slate-400 p-2 rounded-lg ">
              ...
              <div className="relative mb-6  " data-te-input-wrapper-init>
                ...
                <label
                  ...
                  className="content-center text-center pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary"
                >
                  Numero de téléphone
                </label>
              </div>
                ...
                {secondPassword && !confirmPassword ? (
                  ...
                  >
                    ...
                    <span class="block sm:inline">
                      Les mot de passes doit être identique
                    </span>
