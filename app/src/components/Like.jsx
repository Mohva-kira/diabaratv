...
const Like = ({ user, song }) => {
  ...
  const isLiked = likes ? likes?.data.find(like => like?.attributes?.user?.data?.id === user && like?.attributes?.song?.data.id === song) : indexedLikes?.find(like => like?.attributes?.user?.data?.id === 1 && like?.attributes?.song?.data.id === song)
